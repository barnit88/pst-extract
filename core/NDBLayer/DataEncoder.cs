...
namespace core.NDBLayer
{
    public static class DatatEncoder
    {
        ...
        private static readonly byte[] Cyclic1 = new byte[] {
        ...
        private static readonly byte[] Cyclic2 = new byte[] {
        ...
        private static readonly byte[] Compressible = new byte[] {
        ...
        public static void CryptPermute(byte[] pv, int cb, bool fEncrypt, bCryptMethodType encoding)
        {
            if (encoding == bCryptMethodType.NDB_CRYPT_NONE)
                return;
            if (encoding == bCryptMethodType.NDB_CRYPT_PERMUTE)
            {
            ...
            if (encoding == bCryptMethodType.NDB_CRYPT_CYCLIC)
            {
                var key = cb;
                var offset = 0;
